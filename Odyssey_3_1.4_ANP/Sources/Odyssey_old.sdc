...
# output clock
create_generated_clock -name PHY_RX_CLOCK -source [get_pins {tx_pll_c1}] [get_ports {PHY_RX_CLOCK}]
...
set tx_pll_c2    network_inst|rgmii_send:rgmii_send_inst|tx_pll:tx_pll_inst|altpll:altpll_component|tx_pll_altpll:auto_generated|pll1|clk[2]
set tx_pll_c3    network_inst|rgmii_send:rgmii_send_inst|tx_pll:tx_pll_inst|altpll:altpll_component|tx_pll_altpll:auto_generated|pll1|clk[3]
...
create_generated_clock -name clock_12_5MHz -phase 0           -source [get_pins {tx_pll_inclk}] [get_pins {tx_pll_c2}]

create_generated_clock -name clock_2_5MHz -phase 0            -source [get_pins {tx_pll_inclk}] [get_pins {tx_pll_c3}]
